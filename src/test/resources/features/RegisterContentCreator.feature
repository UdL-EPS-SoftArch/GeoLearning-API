Feature: Register ContentCreator
  ...
  Scenario: Register contentcreator with empty password
    ...
    When I register a new contentcreator with username "contentcreator", email "contentcreator@sample.app" and password ""
  ...
  Scenario: Register contentcreator with invalid email
    Given I'm not logged in
    When I register a new contentcreator with username "contentcreator", email "userasample.app" and password "password"
    Then The response code is 400
  ...
  Scenario: Register contentcreator with password shorter than 8 characters
    Given I'm not logged in
    When I register a new contentcreator with username "contentcreator", email "contentcreator@sample.app" and password "pass"
    Then The response code is 400
