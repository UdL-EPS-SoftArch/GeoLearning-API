Feature: CreateMatchResult
  ...
  Scenario: Play a Match
    ...
    When   I played the match and It's created a MatchResult with the result 1 and time 1
    Then   It has been created a matchResult with result 1 and time 1 for this match attached to the player

  Scenario: Play a Match again with better result
    Given  I played the match and It's created a MatchResult with the result 1 and time 1
    ...
    And    It has been created a matchResult with result 2 and time 1 for this match attached to the player
  ...
  Scenario: Play a Match again with lesser result
    ...
    And    It has been created a matchResult with result 1 and time 1 for this match attached to the player