Feature: ImageNameWriteQuestion
  ...
  Scenario: Create without a login
    ...
    When I create a new ImageNameWriteQuestion with image "/image/spain" and solution "spain"
  ...
  Scenario: Create with Content Creator and no image but with solution
    ...
    When I create a new ImageNameWriteQuestion with image "" and solution "spain"
    Then The response code is 400
    And It has not been created a ImageNameWriteQuestion

  Scenario: Create with Content Creator and image but no solution
    Given I login as "creator" with password "password"
    When I create a new ImageNameWriteQuestion with image "/image/spain" and solution ""
    Then The response code is 400
    And It has not been created a ImageNameWriteQuestion
  ...
  Scenario: Create with Content Creator and image with solution
    ...
    And It has been created a ImageNameWriteQuestion with image "/image/spain" and solution "spain"