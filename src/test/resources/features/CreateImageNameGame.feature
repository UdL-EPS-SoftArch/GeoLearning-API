Feature: ImageName
  ...
  Scenario: Create with a login
    ...
    And It has not been created a ImageName with instructions "Relacionar bandera con paises"

  Scenario: Create with normal user
    Given I login as "demo" with password "password"
    When I create a new ImageName with instructions "Relacionar bandera con paises"
    Then The response code is 403
    And It has not been created a ImageName with instructions "Elige la respuesta correcta"
  ...
  Scenario: Create with Content Creator and no instructions
    ...
    Then The response code is 403
    And It has not been created a ImageName
